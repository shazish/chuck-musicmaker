...
7.5::second=> now;
*/
spork ~ myfx.fxPlayback(6, 1.42, 1.5, 0); // int duration, float rate_set, float silent
spork ~ mystifkard.playback(4, 1, 0.12); // duration, timestretch
spork ~ mydrum.playback(4, 6, 0.4); // pattern, length
6::second=> now;
1::second=>now;
spork ~ myfx.fxPlayback(12, 1.42, 1.5, 0);
spork ~ myfx.fxPlayback(12, 1.42, 1, 0); // int duration, float rate_set, float silent
